                            ...
                            <div class="col-sm-8">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Add Blog</h3></div>
                                    <div class="card-body">
                                        <div class="form">
                                            <form class="cmxform form-horizontal tasi-form" id="commentForm" method="post" action="{{url('/Addblog')}}" enctype="multipart/form-data" novalidate="novalidate">
                                            @csrf    
                                            <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <input class="form-control" id="cemail" type="text" name="doctor" required="" aria-required="true">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
