                            ...
                            <div class="col-sm-8">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Add Slider</h3></div>
                                    <div class="card-body">
                                        <div class="form">
                                            <form class="cmxform form-horizontal tasi-form" id="commentForm" method="post" action="{{url('/Addslide')}}" enctype="multipart/form-data" novalidate="novalidate">
                                            @csrf    
                                            <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    <label for="cemail" class="col-form-label col-lg-2">Sub Tittle</label>
                                                    <div class="col-lg-10">
                                                        <input class="form-control" id="cemail" type="text" name="subTittle" required="" aria-required="true">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    <label for="curl" class="col-form-label col-lg-2">Link</label>
                                                    <div class="col-lg-10">
                                                        <input class="form-control" id="curl" type="link" name="link">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="ccomment" class="col-form-label col-lg-2">Description</label>
                                                    <div class="col-lg-10">
                                                        <textarea class="form-control" id="ccomment" name="disc" required></textarea>
                                                    </div>
                                                </div>
