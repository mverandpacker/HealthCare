                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form">
                                            <form class="cmxform form-horizontal tasi-form" id="commentForm" method="post" action="{{url('/updatebenefit')}}" enctype="multipart/form-data" novalidate="novalidate">
                                            @csrf  
                                            
                                         
                                            <input type="hidden" name="id" value="{{$benefit->id}}">
                                            <input type="hidden" name="productid" value="{{$benefit->Product_Id}}">
                                            <div class="form-group row">
                                                    <label for="cname" class="col-form-label col-lg-2">Tittle</label>
                                                    <div class="col-lg-10">
                                                        <input class="form-control" id="cname" name="tittle" value="{{$benefit->Title}}" type="text" required="" aria-required="true">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="curl" class="col-form-label col-lg-2">Photo</label>
                                                    <div class="col-lg-10">
                                                        <input class="form-control" id="curl" type="file" value="{{$benefit->Photo}}" name="photo">
