                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">All Benefit</h4>
                                     <h4 class="text-right">   
                                                <!-- <a href="">
                            ...
                            <div class="col-lg-12">
                                <div class="card card-border card-primary">
                                    ...
                                    <div class="card-header border-primary bg-transparent pb-0">
                                        <h3 class="card-title text-primary "> Benefit</h3>
                                            ...
                                            <div class="table-responsive mb-0" data-pattern="priority-columns">
                                              ...
                                              @foreach($benefit as $val)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <img src="{{url('benefit',$val->Photo)}}" width="50" alt="product">
                                                            </td>
                                                            <td>{{$val->Title}}</td>
                                                            <td>
                                                           ...
                                                           <td>
                                                            <a href="{{route('editbenefit',[$val->id])}}">
                                                            <i class="mdi mdi-content-save-edit-outline text-primary" style="font-size:30px;"></i>
                                                            </a>
                                                           </td>
                                                           <td>
                                                           <a href="{{route('Deletebenefit',[$val->id])}}" onclick="return confirm('Are you sure')" >
